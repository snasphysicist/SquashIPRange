 ...
 * @author scott
 */
public class AboutSquashIPRange extends javax.swing.JDialog {
     ...
     */
    public AboutSquashIPRange(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AboutSquashIPRange.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                AboutSquashIPRange dialog = new AboutSquashIPRange(new javax.swing.JFrame(), true);
